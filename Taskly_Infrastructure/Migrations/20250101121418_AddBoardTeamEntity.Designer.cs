...
namespace Taskly_Infrastructure.Migrations
{
    ...
    [Migration("20250101121418_AddBoardTeamEntity")]
    partial class AddBoardTeamEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoardTeamEntityUserEntity", b =>
                {
                    ...
                    b.HasKey("BoardTeamEntityId", "MembersId");

                    b.HasIndex("MembersId");

                    b.ToTable("BoardTeamEntityUserEntity");
                });
            ...
            modelBuilder.Entity("Taskly_Domain.Entities.BoardTeamEntity", b =>
                {
                    ...
                    b.Property<Guid>("LeaderOfBoardId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Taskly_Domain.Entities.BoardTeamEntity", b =>
                {
                    b.HasOne("Taskly_Domain.Entities.BoardEntity", "Board")
                        .WithOne()
                        .HasForeignKey("Taskly_Domain.Entities.BoardTeamEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
